    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <Card className="p-8 text-center bg-white/90 backdrop-blur-sm border-0 shadow-lg">
            <div className="animate-spin rounded-full h-16 w-16 border-b-4 border-amber-600 mx-auto mb-6"></div>
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Story is being generated</h2>
            <p className="text-gray-600 mb-6">
              Please wait. Creating a unique story may take several minutes.
            </p>
      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <Card className="p-8 text-center bg-white/90 backdrop-blur-sm border-0 shadow-lg">
            ...
            <p className="text-gray-600 mb-6">
              An error occurred while creating the story. Try creating a new one.
            </p>
...
function StoryBook({ story }: { story: StoryResult }) {
  ...
  const expandSceneText = (originalText: string, sceneIndex: number, totalScenes: number): string => {
    ...
    const transitions = [
      "Between the meanwhile", "In the meanwhile", "At this time", "Unexpectedly", "Suddenly", 
    ...
    if (expandedText.length < 150) {
      ...
      expandedText += ` This was truly a ${adjective} moment in history.`;
    }
  ...
  const enhanceSceneText = (originalText: string, sceneIndex: number, totalScenes: number, pageNumber: number): string => {
    ...
    if (sceneIndex > 0) {
      const transitions = ["In the meanwhile", "After this", "Then", "At this time"];
      if (Math.random() > 0.6) {
        const transition = transitions[Math.floor(Math.random() * transitions.length)];
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <div className="space-y-10 mt-12">
              ...
              <p className="text-2xl leading-relaxed text-gray-800 text-justify indent-10 font-serif">
                ...
                Get ready for an incredible journey, full of amazing discoveries and unexpected turns!
              </p>
            </div>
          </div>
            ...
            <div className="flex-1 overflow-hidden">
              ...
              <div className="flex-1 flex items-center justify-center text-center">
                <div className="space-y-8 text-yellow-700 italic">
                  <p className="text-2xl">The story is not written yet...</p>
