  ...
  return (
    <div className="animation-studio-page min-h-screen bg-gray-50">
          ...
          <Card className="mb-6 p-4 bg-orange-50 border-orange-200">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <h3 className="text-orange-800 font-medium mb-1">Video Generation Limit</h3>
                <p className="text-orange-700 text-sm mb-2">
                  New users can generate only <strong>one video</strong>. 
                  Avatars and stories can be created without restrictions.
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="welcome-card text-center py-12">
            <div className="mb-6">
              ...
              <p className="text-gray-600 max-w-md mx-auto">
                Here you can create amazing AI-powered animations. 
      ...
      <Modal
        ...
        description={`Are you sure you want to delete the project "${deleteProjectName}"? This action cannot be undone.`}
        confirmText="Delete"
        cancelText="Cancel"
    ...
    <Card className="project-card hover:shadow-lg transition-shadow relative group">
      ...
      <div className="p-6 cursor-pointer" onClick={onOpen}>
        ...
        <div className="text-xs text-gray-500 flex justify-between">
          <div>Created: {new Date(p.created_at).toLocaleDateString('en-US')}</div>
