...
export function ContentModerationModal({
  ...
  return (
    <div
      className={`fixed inset-0 bg-opacity-5 flex items-center justify-center z-50 p-4 transition-all duration-300 ${
        isOpen ? 'opacity-100' : 'opacity-0'
      }`}
    >
      <Card
        className={`bg-white p-6 max-w-md w-full mx-4 shadow-xl border-0 rounded-xl transform transition-all duration-300 ${
      ...
      >
        ...
        <div className="text-center mb-4">
          ...
          <p className="text-gray-600 text-sm">
            Your description does not comply with our safety guidelines.
          </p>
        </div>
        ...
        <div className="mb-6">
          <p className="text-gray-700 mb-4 text-sm leading-relaxed">
            Our safety system detected elements in your description that
