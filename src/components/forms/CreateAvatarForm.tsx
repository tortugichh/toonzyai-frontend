...
const createAvatarSchema = z.object({
  prompt: z.string().min(10, 'The description must contain at least 10 characters'),
});
...
export function CreateAvatarForm({ 
  ...
  // Show modal if the error is about avatar generation limit
  const isLimitError =
    typeof error === 'string' && error.includes('Only one avatar generation is available');
  ...
  return (
    <>
      ...
      <Modal
        ...
        description="New users can only generate one avatar."
